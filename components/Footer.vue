      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center gap-2 mb-4">
            <img src="/logo.svg" alt="Classsemble Logo" class="w-10 h-10" />
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink to="/website" class="hover:text-teal transition-colors">Home</NuxtLink>
            </li>
            <li>
              <NuxtLink to="/website/features" class="hover:text-teal transition-colors">Features</NuxtLink>
            </li>
            <li>
              <NuxtLink to="/website/plans" class="hover:text-teal transition-colors">Plans</NuxtLink>
            </li>
            <li>
              <NuxtLink to="/website/about" class="hover:text-teal transition-colors">About</NuxtLink>
            </li>
            <li>
              <NuxtLink to="/website/contact" class="hover:text-teal transition-colors">Contact</NuxtLink>
            </li>
          </ul>
        </div>
